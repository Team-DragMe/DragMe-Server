const message = {
  ...
  GET_SUBSCHEDULES_SUCCESS: '하위 계획블록 리스트 조회 성공',
  GET_RESCHEDULES_SUCCESS: '미룬 계획블록 리스트 조회 성공',
  UPDATE_SCHEDULE_TITLE_SUCCESS: '계획블록 이름 수정 성공',
  CREATE_ROUTINE_SUCCESS: '자주 사용하는 계획블록 등록 성공',
  GET_ROUTINES_SUCCESS: '자주 사용하는 계획블록 리스트 조회 성공',
  ...
  GET_CALENDAR_WITH_SCHEDULES_SUCCESS: '날짜별 계획블록 존재 여부 조회 성공',
